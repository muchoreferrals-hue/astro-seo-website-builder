...
echo "  - Playwright MCP connected (claude mcp add playwright npx @playwright/mcp@latest)"
echo "  - An SEO Utils MCP connection, for market validation and rank tracking"
echo "  - Impeccable installed globally (npx impeccable install --scope=global --providers=claude)"
echo ""
